...
class TestZebraGX430tAdapter(unittest.TestCase):
    ...
    def test_oid_reachability_defined(self) -> None:
    ...
    def test_poke_only_response(self, mock_get: MagicMock) -> None:
    ...
    @patch.object(ZebraGX430tAdapter, "_snmp_get")
    def test_garbage_model_name(self, mock_get: MagicMock) -> None:
    ...
    @patch.object(ZebraGX430tAdapter, "_snmp_get")
    def test_poke_and_usage_called(self, mock_get: MagicMock, mock_retry: MagicMock) -> None:
        ...
        self.assertTrue(result["reachable"])
        assert result["meters_total"] is not None
