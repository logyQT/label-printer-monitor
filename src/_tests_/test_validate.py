...
class TestValidateNetwork(unittest.TestCase):
    ...
    def test_checks_all_printers_in_order(self):
    ...
    def test_empty_printers_returns_empty(self):
        issues = validate.validate_network({'snmp': {}, 'printers': []})
        self.assertEqual(issues, [])

    def test_uses_collection_concurrency(self):
