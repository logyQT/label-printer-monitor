...
from adapters.zebra_zt411 import ZebraZT411Adapter, OID_REACHABILITY, OID_LABELS, OID_METERS
...
class TestZebraZT411Adapter(unittest.TestCase):
    ...
    def _make_adapter(self, ip='192.168.40.100'):
    ...
    def test_full_response(self, mock_get, mock_retry):
    ...
    @patch.object(ZebraZT411Adapter, '_snmp_get_retry')
    @patch.object(ZebraZT411Adapter, '_snmp_get')
    def test_labels_only(self, mock_get, mock_retry):
    ...
    @patch.object(ZebraZT411Adapter, '_snmp_get_retry')
    @patch.object(ZebraZT411Adapter, '_snmp_get')
    def test_garbage_model_name(self, mock_get, mock_retry):
